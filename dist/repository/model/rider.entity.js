...
let RiderEntity = class RiderEntity extends sequelize_typescript_1.Model {
    toRider() {
        const rider = {
            id: this.id,
            name: this.name,
...
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING),
    __metadata("design:type", String)
], RiderEntity.prototype, "phone_number", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING),
    __metadata("design:type", String)
], RiderEntity.prototype, "password", void 0);
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => order_entity_1.OrderEntity, 'rider_id'),
    __metadata("design:type", Array)
], RiderEntity.prototype, "orders", void 0);
exports.RiderEntity = RiderEntity = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'rider' })
], RiderEntity);
