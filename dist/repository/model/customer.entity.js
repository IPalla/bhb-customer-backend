...
let CustomerEntity = class CustomerEntity extends sequelize_typescript_1.Model {
    toCustomer() {
        const customer = {
            name: this.name,
            email: this.email,
...
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING),
    __metadata("design:type", String)
], CustomerEntity.prototype, "addressLatitude", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING),
    __metadata("design:type", String)
], CustomerEntity.prototype, "addressLongitude", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.STRING),
    __metadata("design:type", String)
...
], CustomerEntity.prototype, "order", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => order_entity_1.OrderEntity),
    __metadata("design:type", Number)
], CustomerEntity.prototype, "orderId", void 0);
